...
component register_file port(rst : in std_logic; clk: in std_logic;
  ...
  wr_data: in std_logic_vector(15 downto 0); wr_en: in std_logic);
end component;
...
begin
u0:register_file port map(rst=>rst, clk=>clk, rd_index1=>rd_index1, rd_index2=>rd_index2, rd_data1=>rd_data1, rd_data2=>rd_data2,
 wr_index=>wr_index, wr_data=>wr_data,
wr_en=>wr_en);
process begin
...
process begin
  rst <= '1'; rd_index1 <= "000"; rd_index2 <= "000"; wr_en <= '0'; wr_index <= "000";
  wr_data <= X"0000";
      wait until (clk='0' and clk'event); wait until (clk='1' and clk'event); wait until (clk='1' and clk'event);
    rst <= '0';
    wait until (clk='1' and clk'event); wr_en <= '1'; wr_data <= X"200a";
    ...
    wait until (clk='1' and clk'event); wr_en <= '0';
