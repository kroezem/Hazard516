...
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets global_clk_IBUF]
...
set_property PACKAGE_PIN U8 [get_ports {Hsync}]
...
##Pmod Header JC
##Sch name = JC1
set_property PACKAGE_PIN K17 [get_ports global_clk]
...
##Sch name = JC3
#set_property PACKAGE_PIN N17 [get_ports {out_port[0]}]
#	set_property IOSTANDARD LVCMOS33 [get_ports {out_port[0]}]
##Sch name = JC4
